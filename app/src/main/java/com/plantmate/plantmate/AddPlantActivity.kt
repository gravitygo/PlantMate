        ...
        binding.confirmAddButton.setOnClickListener{
            ...
            db.collection("users")
                ...
                .addOnSuccessListener { documentReference ->
                    ...
                    renderOption.content = "putangina." // content to encode
                    ...
                    val color = Color()
                    color.light =  R.color.qr_color // for blank spaces
                    color.dark = R.color.qr_color // for non-blank spaces
                    color.background = R.color.qr_color
                    ...
                    val result = AwesomeQrRenderer.renderAsync(renderOption, { renderRes ->
                        if (renderRes.bitmap != null) {
                            saveImageToGallery(applicationContext, renderRes.bitmap!!, "QR Code", "QR Code generated by AwesomeQRCode")

                        } else if (renderRes.type == RenderResult.OutputType.GIF) {

                        } else {
                            // Oops, something gone wrong.s
                        }
                    }, {
