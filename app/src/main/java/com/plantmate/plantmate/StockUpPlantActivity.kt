...
class StockUpPlantActivity : AppCompatActivity(){
    ...
    private val textWatcher = object : TextWatcher {
        ...
        override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
            ...
            if (binding.stockInput.text.toString().trim().isNotEmpty() && binding.priceInput.text.toString().trim().isNotEmpty()){
                ...
                binding.confirmModifyButton.backgroundTintList = ColorStateList.valueOf(getColor(R.color.purple_primary))
            }
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.stockText.text = "New Stocks:"
        binding.priceText.text = "Price Bought (php):"
        binding.totalTitle.text = "Purchase Total:"
        binding.confirmModifyButton.text = "Stock Up"

        binding.stockText.setTextColor(getColor(R.color.purple_primary))
        binding.priceText.setTextColor(getColor(R.color.purple_primary))
        binding.totalTitle.setTextColor(getColor(R.color.purple_primary))
        binding.totalPrice.setTextColor(getColor(R.color.purple_primary))
        binding.totalPhp.setTextColor(getColor(R.color.purple_primary))
        binding.cardView.setCardBackgroundColor(getColor(R.color.purple_primary))
    ...
    private fun showConfirmationDialog() {
        ...
        dialogTitle.setTextColor(getColor(R.color.purple_primary))

        val dialogMessage = view.findViewById<TextView>(R.id.dialog_message)
        dialogMessage.text ="you are about to stock up ${binding.stockInput.text} plants"
        ...
        confirmButton.backgroundTintList = ColorStateList.valueOf(getColor(R.color.purple_primary))
