...
class DisposePlantActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.stockText.text = "Perished Stocks:"
        binding.priceText.text = "Price Lost (php):"
        binding.totalTitle.text = "Perished Stock Total"
        binding.confirmModifyButton.text = "Dispose"

        binding.stockText.setTextColor(getColor(R.color.red_primary))
        binding.priceText.setTextColor(getColor(R.color.red_primary))
        binding.totalTitle.setTextColor(getColor(R.color.red_primary))
        binding.totalPrice.setTextColor(getColor(R.color.red_primary))
        binding.totalPhp.setTextColor(getColor(R.color.red_primary))
        binding.cardView.setCardBackgroundColor(getColor(R.color.red_primary))
        binding.confirmModifyButton.backgroundTintList =
    ...
    private fun showConfirmationDialog() {
        ...
        dialogTitle.setTextColor(getColor(R.color.red_primary))

        val dialogMessage = view.findViewById<TextView>(R.id.dialog_message)
        dialogMessage.text = "you are about to dispose ${binding.stockInput.text} plants"
        ...
        confirmButton.backgroundTintList = ColorStateList.valueOf(getColor(R.color.red_primary));
